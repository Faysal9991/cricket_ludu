            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                    style: ElevatedButton.styleFrom(backgroundColor: Colors.white, shadowColor: Colors.green, shape: const StadiumBorder()),
                    onPressed: () {},
                    child: Row(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Padding(
                              ...
                              child: BetingCard(
                                  ...
                                  matchName: "${game.name}",
                                  image:
                                      "https://e7.pngegg.com/pngimages/673/759/png-clipart-dicedice-israel-yahtzee-naija-ludo-android-game-logo-thumbnail.png",
                                  ...
                                  joinButtun: game.slotoneusers.contains(profileModel.uid) ||
                                          ...
                                          (game.slotonecapacity! <= game.slotoneusers.length &&
                                              game.slottwocapacity! <= game.slottwousers.length)
                                      ? null
                                      : () async {
                                          if (profileModel.totalBalance! >= game.entryFee!) {
                                                ...
                                                child: Column(
                                                  children: [
                                                    ...
                                                    Padding(
                                                      padding: const EdgeInsets.all(8.0),
                                                      child: Text(
                                                        "Your joining ID number is : ${profileModel.uid}",
                                                    ...
                                                    Padding(
                                                      padding: const EdgeInsets.all(8.0),
                                                      child: Text(
                                                        "After win Take a screen Sort  go to profile and tap the button which nme screen sort.After press it you submit your screen sort our team will response soon, you must get your prize money",
                                                    ...
                                                    Text(
                                                      ...
                                                      style: GoogleFonts.ebGaramond(
                                                          color: Colors.white, fontWeight: FontWeight.bold, fontSize: height * 0.04),
                                                    )
                                                  ],
                                                ),
                                              ),
                                            ...
                                            ScaffoldMessenger.of(context)
                                                .showSnackBar(SnackBar(content: Text("You don't have enough money, please recharge")));
                                          }
                                        }));
                        })
                    : Center(
